...
class Outtake {
    object Outtake: Subsystem {
        ...
        override fun periodic() {
            ...
            lightFlashPower = if (lightFlashPower == 1.0) {
                0.0
            } else {
                1.0
            }
            if (longVelocity + 20 >= rMotor.velocity && rMotor.velocity >= shortVelocity - 20) {
                lightOn
            } else if (shortVelocity + 20 >= rMotor.velocity && rMotor.velocity >= shortVelocity) {
                lightFlash
            } else {
                lightOff
            }
